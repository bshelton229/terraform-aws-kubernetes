...
module "vpc" {
  source = "github.com/coreos/tectonic-installer//modules/aws/vpc?ref=1.8.4-tectonic.3"
...
module "etcd" {
  source = "github.com/coreos/tectonic-installer//modules/aws/etcd?ref=1.8.4-tectonic.3"
...
module "masters" {
  source = "github.com/coreos/tectonic-installer//modules/aws/master-asg?ref=1.8.4-tectonic.3"
...
module "workers" {
  source = "github.com/coreos/tectonic-installer//modules/aws/worker-asg?ref=1.8.4-tectonic.3"
...
module "dns" {
  source = "github.com/coreos/tectonic-installer//modules/dns/route53?ref=1.8.4-tectonic.3"
